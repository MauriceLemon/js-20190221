...
/* harmony import */ var _styles_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(21);
...
function (_Component) {
  ...
  function PhonesPage(element, props) {
    ...
    _this.onPhoneSelected = function (phoneId) {
      return _this.selectedPhone(phoneId);
    };

    _this.onAdd = function (phoneId) {
      return _this.addItem(phoneId);
    };

    _this.onBack = function () {
      return _this.unselectedPhone();
    };

    _this.onRemove = function (itemToRemove) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_5___default()(PhonesPage, [{
    ...
    key: "unselectedPhone",
    value: function unselectedPhone() {
      this.setState({
        selectedPhone: null
      });
    }
